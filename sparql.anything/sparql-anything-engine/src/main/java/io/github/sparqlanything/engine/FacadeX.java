...
public final class FacadeX {
	...
	static {
		try {
			...
			Registry.registerTriplifier("io.github.sparqlanything.parquet.ParquetTriplifier", new String[]{"parquet"}, new String[]{"application/vnd.apache.parquet", "application/x-parquet"});
